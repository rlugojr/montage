...
var ObjectModel = exports.ObjectModel = Montage.specialize( /** @lends ObjectModel.prototype # */ {
    ...
    deserializeSelf: {
        value: function (deserializer) {
            ...
            this.objectModelInstanceModuleId = deserializer.getProperty("objectModelModuleId") || deserializer.getProperty("binderModuleId");
        }
    },
    ...
    manager: {
        get: deprecate.deprecateMethod(void 0, function () {
            return exports.ObjectModel.group;
        }, "Binder.manager", "ObjectModel.group")
    }
